...
public class MissionController {
    ...
    private final MissionService begsService;
    ...
    public ResponseEntity<?> acceptBegging(@RequestBody BegAcceptRequestDto requestDto){
        ...
        return ResponseDto.response(begsService.begAccept(requestDto));
    }

    // 미션 부여
    @PostMapping("/assign")
    public ResponseEntity<?> assignMission(@RequestBody AssignMissionRequestDto requestDto){
        return ResponseDto.response(begsService.assignMission(requestDto));
    }
